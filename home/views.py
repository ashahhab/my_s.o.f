...
from .forms import CommentCreateForm, PostCreateUpdateForm, CommentReplyForm, PostSearchForm
...
class PostDetailView(View):
    ...
    def post(self, request,*args, **kwargs):
        ...
        if form.is_valid():
            ...
            new_comment.save()
            messages.success(request, 'you comment submited successfully', 'success')
